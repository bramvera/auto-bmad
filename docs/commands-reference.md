...
For epic selection, `all` means all runnable/pending epics. Completed epics are excluded. Wizard reset only rebuilds the Auto-BMAD plan from current sprint status; it is not a hard project startover.
