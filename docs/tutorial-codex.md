...
When selecting epics, choose `A` for recommended runnable epics or `B` to enter explicit epic numbers. Completed epics are skipped; hard startovers require an intentional project/git reset outside the wizard.
