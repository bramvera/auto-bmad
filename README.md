...
- In the wizard, choose `A` for recommended runnable epics or `B` to enter explicit epic numbers. Completed epics are excluded from the runnable plan; hard startovers require an intentional project/git reset outside the wizard.
