...
- In the wizard, choose `recommended` or explicit epic numbers. Completed epics are excluded from the runnable plan; hard startovers require an intentional project/git reset outside the wizard.
