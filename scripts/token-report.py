...
def build_markdown(session: dict, steps: list[dict], project_path: Path) -> str:
    ...
    md = [
        ...
        "",
        "> **Disclaimer:** All costs are estimates only. Actual billing may differ due to model pricing changes, ",
        "> data residency multipliers, fast mode, or unrecognised models using family-based fallback pricing.",
        "> Always verify against your Anthropic Console usage dashboard.",
        "> Pricing last verified 2026-03-23 from platform.claude.com/docs/en/about-claude/pricing",
        "",
        "## Cost by Token Type",
        "",
